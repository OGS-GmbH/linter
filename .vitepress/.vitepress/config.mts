...
export default defineConfig({
  ...
  title: "linter",
  description: "Linter rules to enforce consistent, high-quality code across projects.",
  themeConfig: {
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "Setup", items: [
            ...
            { text: "Commitlint", link: "/guide/setup/commitlint" },
            { text: "package.json-lint", link: "/guide/setup/package-json" }
          ] },
